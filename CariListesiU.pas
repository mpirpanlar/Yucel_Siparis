...
type
  TfrmCariListesi = class(TUniForm)
...
function frmCariListesi: TfrmCariListesi;
...
uses
  MainModule, uniGUIApplication, SiparisU, Genel, Main, CariDetayU;

function frmCariListesi: TfrmCariListesi;
begin
  Result := TfrmCariListesi(UniMainModule.GetFormInstance(TfrmCariListesi));
end;

procedure TfrmCariListesi.btnListeleClick(Sender: TObject);
Var
CariAdi :String;
SL: TStringList;
i:integer;
...
procedure TfrmCariListesi.UniButton1Click(Sender: TObject);
begin
...
procedure TfrmCariListesi.UniButton2Click(Sender: TObject);
begin
    MainForm.NavPage.ActivePage.Close;
end;

procedure TfrmCariListesi.UniFormShow(Sender: TObject);
begin
